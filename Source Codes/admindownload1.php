...
<body>
  ...
  <div>
    ...
    <br>
    <br>
    <center><button style="width:100px; height:30px; border-radius:5px; margin-right:40px; border-width: 5px; background-color: rgb(19, 185, 19); border-style: none"><a href="addcompany1.php" class="mahi">Update COMPANY</a></button></center>
            <center><button style="width:100px; height:30px; border-radius:5px; margin-right:40px; border-width: 5px; background-color: rgb(19, 185, 19); border-style: none"><a href="addnewcompany.php" class="mahi">New COMPANY</a></button></center>
    <br>
    </div>
</body>
